...
absolute values of the secondary targets (as above). At `0`, the secondary
target tables are scaled so that the average weight matches the primary average.
In effect, this means that only the percentage distribution of the secondary
tarets is important.
